...
try{
 ...
 assert.equal(await deck.getAttribute('data-menu'),'SOUND');assert.equal(await deck.getAttribute('data-menu-item'),'DUST');
 ...
 assert.equal(await deck.getAttribute('data-menu'),'SOUND');assert.equal(await deck.getAttribute('data-menu-item'),'PULSE');
 await dial.click();await page.waitForFunction(()=>document.querySelector('[data-tape-deck]').dataset.baseSound==='pulse');
 ...
 assert.equal(await deck.getAttribute('data-tracks'),'1000');assert.equal(await deck.getAttribute('data-selected-layer'),'2');
 ...
 await dial.click();await dial.click();await dial.press('ArrowUp');await dial.press('ArrowUp');await dial.press('ArrowUp');await dial.press('ArrowUp');await dial.click();
 ...
 await dial.click();await dial.click();await dial.click();await page.waitForFunction(()=>document.querySelector('[data-tape-deck]').dataset.baseSound==='dust');
 ...
 await page.waitForFunction(()=>document.querySelector('[data-tape-deck]').dataset.baseSound==='custom');await dial.click();await dial.click();await dial.press('ArrowUp');await dial.click();assert.equal(await deck.getAttribute('data-menu'),'REPLACE L1');assert.equal(await deck.getAttribute('data-base-sound'),'custom');await dial.click();assert.equal(await deck.getAttribute('data-menu'),'SOUND');assert.equal(await deck.getAttribute('data-base-sound'),'custom');
 await dial.press('Escape');await dial.press('Escape');
 ...
 assert.deepEqual(errors,[]);console.log('PASS: startup spin/silence, click/drag/touch menus, real audio, mic recording, base choices/off, replace confirmation, tempo, sticky nav, viewport overflow.');
